# -*- coding: utf-8 -*-
#
# portable-ca-bundle documentation build configuration file, created by
...
htmlhelp_basename = 'portable-ca-bundledoc'
...
latex_documents = [
  ('index', 'portable-ca-bundle.tex', u'portable-ca-bundle Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'portable-ca-bundle', u'portable-ca-bundle Documentation',
     [u''], 1)
]
